...
def test_number_to_nepali_words():
    ...
    assert number_to_nepali_words(25) == "पच्चिस"
    # assert number_to_nepali_words(67) == "सत्तसठी"
    assert number_to_nepali_words(100) == "एक सय"
    assert number_to_nepali_words(125) == "एक सय पच्चिस"
    assert number_to_nepali_words(1012) == "एक हजार बाह्र"
    assert number_to_nepali_words(100000) == "एक लाख"
    # assert number_to_nepali_words(1234567) == "बाह्र लाख चौतीस हजार पाँच सय सत्तरी सात"
